...
import 'package:codon/features/videos/screens/video_chapters_screen.dart';
...
class VideoSubSubjectsScreen extends StatelessWidget {
  final SubjectModel subject;
  const VideoSubSubjectsScreen({super.key, required this.subject});
  ...
  Widget _buildSubSubjectCard(dynamic subSubject) {
    return Container(
      ...
      child: InkWell(
        onTap: () => Get.to(() => VideoChaptersScreen(subSubject: subSubject)),
        child: ListTile(
          title: Text(
            subSubject.name ?? 'N/A',
            maxLines: 2,
