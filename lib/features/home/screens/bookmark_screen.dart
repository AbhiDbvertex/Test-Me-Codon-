        ...
        child: InkWell(
          ...
          onTap: () {
            ...
            if (bookmark.type == 'chapter' && bookmark.chapter != null) {
              ...
              Get.to(
                BookmarkMCQdetailScreen(
                  id: bookmark.mcq?.id,
                  title: bookmark.mcq?.name,
                ),
              );
              ...
              Get.to(
                QTestModuleScreen(
                  chapterId: "69946c182438e61fddf8a542",
                  chapterName: '',
                ),
              );
                          ...
                          Obx(() {
                            ...
                            String _getCorrectItemId(BookmarkModel b) {
                              ...
                              switch (t) {
                                ...
                                default:
                                  return b.itemId.isNotEmpty ? b.itemId : b.id;
                              }
                            }

                            final String itemId = _getCorrectItemId(bookmark);

                            final bool isBookmarked = bookmarkCtrl.isBookmarked(
                              itemId,
                            );
                            final String? currentCategory = bookmarkCtrl
                                .getCategory(itemId);

                            Color iconColor = Colors.grey.withValues(
                              alpha: 0.7,
                            );

                            if (isBookmarked && currentCategory != null) {
                              final cat = currentCategory.toLowerCase().trim();
                              if (cat.contains('mostimportant') ||
                                  cat.contains('most imp')) {
                                iconColor = Colors.red.shade700;
                              } else if (cat.contains('veryimportant') ||
                                  cat.contains('very imp')) {
